...
void reshape(int width, int height)
{
   ...
   glLoadIdentity();
   gluPerspective(50.0,1.0,15.0,6000.0);  //Perspective
...
//Smoke trails for planes
  drawSmoke(1,0.5,0.2,+180,0,1);//new with smoke
  drawSmoke(1,0.5,0.2,120,0,1);
  drawSmoke(1,1,1,60,0,1);
...
void front()
{
	...
	output(310,650,"                     ",fonts[2]);
	glColor3f(1.0,1.0,0.0);
	output(300,600,"DEPARTMENT OF COMPUTER SCIENCE",fonts[2]);
	//glColor3f(0.8,0.1,0.2); red
	glColor3f(1.0,1.0,1.0);
	output(280,500,"GRAPHICAL IMPLEMENTATION ON AVIATION",fonts[2]);
	glColor3f(0.8,0.1,0.2);
	output(390,400,"SUBMITTED BY :",fonts[2]);
	glColor3f(0.3,0.5,0.8);
	output(180,350,"                                   1] NANDA KUMAR V - 1AM20CS124",fonts[2]);
	output(180,300,"                                   2] NEELESH S - 1AM20CS127",fonts[2]);
	output(180,250,"                                   3] NISCHITH PM - 1AM20CS129",fonts[2]);
	output(180,200,"                                   4] YOUNUS SABERI - 1AM20CS165",fonts[2]);
// 	glColor3f(0.6,0.25,0.0);
	output(360,100,"[ PRESS ANY KEY TO CONTINUE ]",fonts[3]);
}
void menu()
{
	glColor3f(0.8,0.1,0.2);
	output(170,480,"GRAPHICAL IMPLEMENTATION OF AVIATION",fonts[2]);
...
{
	glColor3f(0.8,0.1,0.2);
	output(170,600,"GRAPHICAL IMPLEMENTATION OF AVIATION",fonts[2]);
	glColor3f(0.0,0.6,0.3);
	...
	output(180,360,"=> [F] FOR START <=",fonts[3]);
